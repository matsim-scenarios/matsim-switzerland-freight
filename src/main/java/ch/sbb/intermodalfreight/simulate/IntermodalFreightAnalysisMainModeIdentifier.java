...
import ch.sbb.intermodalfreight.prepare.supply.KVModes;
 ...
 *
 */
public final class IntermodalFreightAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {
	// Please do not lightheartedly change this class, you are not the only user affected.

	private static final Logger log = LogManager.getLogger(IntermodalFreightAnalysisMainModeIdentifier.class);

	private final List<String> modeHierarchy = new ArrayList<>() ;

	public IntermodalFreightAnalysisMainModeIdentifier() {
		...
		modeHierarchy.add( KVModes.CAR_KV_CONTAINER ) ;
		modeHierarchy.add( KVModes.CAR_KV_TEU ) ;
		modeHierarchy.add( KVModes.CAR_KV_SATTELAUFLIEGER ) ;
		modeHierarchy.add( KVModes.CAR_KV_WECHSELBEHAELTER ) ;
